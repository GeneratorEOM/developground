...
%>
		...
		<td><a href="../upload/<%=bb.getFile()%>"><img src="../images/down.png" width="20" height="20"></a></td>
		</tr>
		<%
...
<div id="buttons">
<input type="button" value="뒤로가기" onclick="return back()" class="submit" style="margin-left: 350px; ">
</div>
<div id="page_control">
<%
