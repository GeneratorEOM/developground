...
function fun1() {
	...
	if(document.fr.file.value!=null) {
		document.fr.encoding = "multipart/form-data"
	}
	document.fr.action="writePro.jsp"	
}
...
Cookie cookie = new Cookie("cook", "f"+id+num);
...
for(int i=0;i<cookies.length;i++){
	...
	if(cookies[i].getValue().equals("f"+id+num)){
...
<table class="table01">
	...
	<tr class="tr04">
		...
		<td class="tup" colspan="2"><span id="like2" style="font-size: 18px;"><%=bb.getBoard_like() %></span><a  href="javascript:void(0); onclick=like('<%=id %>')" style="text-decoration:none; " id="like"><img src="../images/like.PNG" width="55" height="55"></a></td>
	</tr>
...
for(int i=0;i<commentList.size();i++) {
	FileCommentBean cb = (FileCommentBean)commentList.get(i);
