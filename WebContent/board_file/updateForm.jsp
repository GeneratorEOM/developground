...
<jsp:include page="../inc/top.jsp" />
	<div id="main">
		...
		<div id="welcome">
			<div class="title">
				<h2 style="margin-bottom: 20px;">글수정</h2>
...
%>
<form action="updatePro.jsp" method="post" name="fr" enctype="multipart/form-data" onsubmit="return fun1()">
<input type="hidden" name="num" value="<%=num%>">
<table class="table01">
	<tr class="tr01">
		<th>작성자</th>
		<td colspan="2" class="tname"><%=bb.getId()%></td>
	</tr>
	<tr>
	...
	<tr>
		<th>파일</th>
		<th><input type="text" name="file2" id="file2" value="<%=bb.getFile()%>" style="border:none; outline:none; font-size: 10pt;" readonly></th>
	</tr>
	<tr>
		<th></th>
		<th><input type="file" name="file" onchange="javascript:document.getElementById('file2').value = this.value.substring(this.value.lastIndexOf('\\')+1)"></th>
	</tr>
	<tr>
	<tr class="tr03">
		<td colspan="2" class="content"><textarea name="content" rows="30" cols="100"><%=bb.getContent() %></textarea></td>
