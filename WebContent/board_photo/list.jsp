...
<article style="width: 750px; height: 800px;">
...
%>
			...
			<div style="; float: left; margin: 5px 5px 3px 90px">
			<table>		
			<tr>
...
<form action="PhotoBoardSearch.jsp" method="post" style="margin: 0; padding: 0; ">
<input type="text" name="search" class="input_box" style="margin-top: 30px; margin-left: 460px;">
