...
#buttons {
	margin-right: 330px; margin-top: 20px;
}
#page_control {
...
#page_control a{text-align: center; text-decoration: none;
...
<div id="buttons" >
<input type="button" value="글쓰기" class="submit" onclick="return write2('<%=id%>')">
</div>
<div id="page_control">
